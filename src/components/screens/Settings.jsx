...
import { ArrowLeft, ChevronRight, User, ShieldCheck, Bell, BookOpen, Heart, HelpCircle, Info, LogOut, Power, AlertTriangle, Trash2 } from 'lucide-react';
...
export default function Settings({ onBack, activeTab, onNavigate, onSection, onSignOut, onExitApp, onDeleteAccount }) {
  ...
  const sections = [
    { title: 'Account', items: [
      ...
      { icon: ShieldCheck, label: 'Account & Security', key: 'accountSecurity' },
      { icon: ShieldCheck, label: 'Privacy', key: 'privacy' },
    ]},
    { title: 'Preferences', items: [
      { icon: Bell, label: 'Notifications', key: 'notifications' },
      { icon: Heart, label: 'Prayer Preferences', key: 'prayerPreferences' },
      { icon: BookOpen, label: 'Display & Appearance', key: 'display' },
      { icon: BookOpen, label: 'Language', key: 'language' },
    ]},
    { title: 'Support', items: [
      ...
      <div className="mt-4 px-4 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-2xl border border-red-200 bg-red-50 py-4 font-semibold text-red-700 transition active:scale-[0.98]"
          >
          ...
          <div className="rounded-2xl border border-red-200 bg-red-50 p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-red-700">This action cannot be undone. All your data including prayers, testimonies, and settings will be permanently deleted.</p>
                <div className="mt-3 flex gap-2">
                  <button
                    onClick={handleDeleteAccount}
                    className="rounded-xl bg-red-600 px-4 py-2 text-xs font-semibold text-white transition active:scale-95"
                  >
                    Yes, Delete Account
                  </button>
                  <button
