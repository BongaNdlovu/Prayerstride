  ...
  return (
    <Card onClick={onPress} className="p-4">
      ...
      <div className="mt-3 flex items-center gap-5 text-xs text-slate-500">
        <span className="flex items-center gap-1"><Heart size={14} /> {testimony.amen || 0}</span>
        <span className="flex items-center gap-1"><MessageCircle size={14} /> {testimony.praiseGod || 0}</span>
      </div>
    </Card>
  );
}
