    ...
    <ScreenScaffold pageContent>
      ...
      <GlassCard style={{ marginTop: 16 }}>
        ...
        <BodyText variant="body" style={{ marginTop: 8 }}>
          PrayerStride includes third-party fonts, icons, and platform services used under their respective licenses (for example, Playfair Display and DM Sans fonts, Lucide icons, Firebase, Expo, and Cloudflare). Those components remain subject to their own terms; they do not make PrayerStride open source.
        </BodyText>
      </GlassCard>
    </ScreenScaffold>
  );
